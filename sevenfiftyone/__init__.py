...
import os
from flask import (
    Flask, request, render_template, flash, redirect, url_for, jsonify, session
)
...
from flask.ext.login import (
    LoginManager, current_user, AnonymousUserMixin, login_user, logout_user
)
...
def get_login():
    return render_template(
        'login.html', form=LoginForm(), ref=request.args.get('next', None)
    )
